...
$("#startover").click(function() {
    ...
    // Clear existing country selector options
    d3.select("#country_select_container").selectAll("select").remove();

    // Reset radio buttons to the default (Total) after start over
...
$("input[name='type']").click(function() {
    ...
    draw(selectedCountry, true, selectedType);
});
